# Generated by Django 3.0.3 on 2020-05-15 04:17
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('menu', 'menu'), ('tanitim', 'tanitim'), ('duyuru', 'duyuru'), ('etkinlik', 'etkinlik')], max_length=10)),
                ('title', models.CharField(max_length=150)),
                ('keywords', models.CharField(blank=True, max_length=255)),
                ('description', models.CharField(blank=True, max_length=255)),
                ('thumbnail', models.ImageField(blank=True, default='images/null.jpg', upload_to='images/content/')),
